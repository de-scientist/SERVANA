...
ALTER TABLE "FraudAlert" ADD COLUMN "checkKey" TEXT NOT NULL DEFAULT 'legacy';ALTER TABLE "FraudAlert" ADD COLUMN "evidence" JSONB;
...
-- Referral velocity analysis needs creation timestamps.
ALTER TABLE "Referral" ADD COLUMN "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
